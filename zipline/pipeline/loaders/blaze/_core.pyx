...
cdef arrays_from_rows(DatetimeIndex_t dates,
    ...
    print(dates)
    print('data query')
    print(data_query_cutoff_times.tz_convert(None).searchsorted(all_rows[TS_FIELD_NAME].values,'right'))
    print('arrays from rows')
    print(all_rows[TS_FIELD_NAME].values)
